...
begin
  ...
  begin
    ...
    -- test data
    -- test values in A[0] through A[6]
    for i in 0 to 6 loop
      ...
      RS1 <= "11001";  -- x25 
      RS2 <= "00011";  -- x3 
      imm <= std_logic_vector(to_unsigned(i*4, 12)); 
      ALUSrc <= '1';
      RegWrite <= '0';
      memWrite <= '1';
      wait for 1 ns;
